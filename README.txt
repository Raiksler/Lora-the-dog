...
ВАЖНО! При каждом запуске, бот будет запрашивать ваш токен. Для того, чтобы этого избежать, можно добавить ваш токен в переменную окружения файла env.py, в этом случае, бот перестанет запрашивать токен при каждом запуске и будет использовать заданный вами по умолчанию.
